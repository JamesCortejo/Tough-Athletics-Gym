...
class AdminActiveMembers {
        ...
        <tr>
          <td>
            <div class="d-flex align-items-center">
              <img src="${
                member.profilePicture || "/images/pfpImages/defaultPfp.png"
              }" 
                   alt="Profile" 
                   class="rounded-circle me-3"
                   style="width: 40px; height: 40px; object-fit: cover;"
                   onerror="this.src='/images/pfpImages/defaultPfp.png'">
              <div>
  ...
  async populateMemberDetailsModal() {
    ...
    profilePicture.src =
      user?.profilePicture || "/images/pfpImages/defaultPfp.png";
    profilePicture.onerror = function () {
      this.src = "/images/pfpImages/defaultPfp.png";
    };

    document.getElementById("memberDetailName").textContent =
    ...
    // QR Code ID
    document.getElementById("memberQrCodeId").textContent =
      `QR Code ID: ${membership.qrCodeId}`;
    ...
    document.getElementById("statCheckinRate").textContent =
      `${statistics.checkinRate}%`;
